SERVICE_ROLE_ARN = '{{cookiecutter.service_name}}RoleArn'
LAMBDA_BASIC_EXECUTION_ROLE = 'AWSLambdaBasicExecutionRole'
SERVICE_ROLE = '{{cookiecutter.service_name}}Role'
...
SERVICE_NAME = 'Orders'
SERVICE_NAME_TAG = '{{cookiecutter.service_name}}'
OWNER_TAG = 'owner'
METRICS_NAMESPACE = 'orders_kpi'
METRICS_DIMENSION_KEY = '{{cookiecutter.service_name}}'
